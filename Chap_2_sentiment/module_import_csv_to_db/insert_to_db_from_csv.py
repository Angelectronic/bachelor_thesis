    ...
    if tabel_ == "CHU_DE":
        try :
            for index, row in data.iterrows():
                ...
                insert = sql.insert_to_db(tabel_, "Ten,Dong_nghia,Tich_cuc,Tieu_cuc,id_chu_de_con", (f"N'{Ten}'",f"N'{Dong_nghia}'",f"N'{Tich_cuc}'",f"N'{Tieu_cuc}'",f"N'{id_chu_de_con}'"))
